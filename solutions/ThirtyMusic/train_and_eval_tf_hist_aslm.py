...
from solutions.ThirtyMusic import stabr_history_aslm
...
def run_train_test():
    ...
    for index in range(3):
        ...
        stabr = stabr_history_aslm.STABR(TOTAL_SONGS + 1, SONG_EMBEDDING_SIZE, TOTAL_TAGS + 1,
        ...
        checkpoint_cb = tf.keras.callbacks.ModelCheckpoint(
            "stabr_hist_aslm_30music_models/stabr_30music_set_" + str(index) + "_{epoch}.ckpt",
        ...
        if "train" in sys.argv:
            ...
            eval_model_path = "stabr_hist_aslm_30music_models/stabr_30music_set{}_{}.ckpt".format(index, sys.argv[2])
            for k in [1, 5, 10, 20, 30, 40, 50]:
                stabr_eval = stabr_history_aslm.STABR(TOTAL_SONGS + 1, 
                                                      SONG_EMBEDDING_SIZE, 
                                                      TOTAL_TAGS + 1,
                                                      TAG_EMBEDDING_SIZE, 
                                                      HIDDEN_SIZE, 
            ...
            EPOCH = sys.argv[2]
            eval_model_path = "stabr_hist_aslm_30music_models/stabr_hist_30music_set{}_{}.ckpt".format(index, EPOCH)
            init_data = iter(train_dataset).next()
            inp, target = init_data
            ...
            stabr.fit(train_dataset, 
                      ...
                      verbose=1, 
                      callbacks=[checkpoint_cb], 
                      shuffle=False, initial_epoch=EPOCH)
        else:
