...
from solutions.ThirtyMusic import stabr_tf_attless
...
def run_train_test():
    ...
    for index in range(3):
        ...
        stabr = stabr_tf_attless.STABR(TOTAL_SONGS + 1,
                                       SONG_EMBEDDING_SIZE,
                                       TOTAL_TAGS + 1,
                                       TAG_EMBEDDING_SIZE,
                                       HIDDEN_SIZE,
        ...
        checkpoint_cb = tf.keras.callbacks.ModelCheckpoint(
            "stabr_attless_30music_models/stabr_30music_set" + str(index) + "_{epoch}.ckpt",
