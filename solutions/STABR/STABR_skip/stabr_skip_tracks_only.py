...
class STABR_song_encoder(tf.keras.layers.Layer):
    def __init__(self, input_size, skips_input_size, hidden_size=64, song_embedding_size=50,
                 skips_embedding_size=5, name="STABR_song_encoder", **kwargs):
    ...
    def call(self, input_tracks, input_skips):
...
class STABR(tf.keras.Model):
    def __init__(self, song_input_size, song_embedding_size,
        ...
        self.song_encoder = STABR_song_encoder(song_input_size, skips_input_size,
            hidden_size=hidden_size, song_embedding_size=song_embedding_size, skips_embedding_size=skips_embedding_size)
    ...
    def call(self, inp, training=None):
        ...
        songs_context = self.song_encoder(input_songs, input_skips)
