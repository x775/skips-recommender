...
from solutions.STABR.STABR_history_aslm import stabr_history
from solutions.STABR.STABR_history_aslm import data_handling_tf
...
def eval_hit_ratio_at_k(network, test_data, k=10):
    ...
    r = {"results": results}
    with open("STABR_HIST_results_k_{}.json".format(k), "w") as out:
        json.dump(r, out)
...
def run_train_test():
    ...
    TRACK_HISTORY_HIDDEN_SIZE = 96
    TAG_HISTORY_HIDDEN_SIZE = 96
    HISTORY_SIZE = 10
    DROPOUT = 0.1
    V_LAYER_SIZE = 50
