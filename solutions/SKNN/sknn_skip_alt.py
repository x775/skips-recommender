...
if __name__ == "__main__":
    ...
    if sys.argv[1] == "train":
        ...
        sparse.save_npz("trained_sknn_skip_positive_tf.npz", trained_sknn)
    if sys.argv[1] == "eval":
        # Load the saved training sparse matrix; in csr format.
        trained_sknn = sparse.load_npz("trained_sknn_skip_positive_tf.npz")
    ...
    for neighbour in neighbours:
        for k in topk:
            ...
            with open("sknn_skip_positive_results.txt", "a") as out:
